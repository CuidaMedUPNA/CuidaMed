document.addEventListener("DOMContentLoaded", () => {
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", async (e) => {
      ...
      if (
        ...
        showMessage("Por favor rellena todos los campos requeridos.", "error");
        return;
      }
      ...
      try {
        // Enviar con EmailJS
        const response = await emailjs.send("service_2a54vdo", "contacto", {
  ...
  const downloadBtn = document.querySelector('a[href="index.html#final-cta"]');
  if (downloadBtn) {
