...
import type {
  ...
  GetAllMedicinesData,
  GetAllMedicinesError,
  GetAllMedicinesResponse,
  GetIntakesByTreatmentData,
  GetIntakesByTreatmentError,
  GetIntakesByTreatmentResponse,
  GetTreatmentByIdData,
  GetTreatmentByIdError,
...
export const getTreatmentsQueryKey = (options: Options<GetTreatmentsData>) =>
  createQueryKey("getTreatments", options);
...
export const getTreatmentsOptions = (options: Options<GetTreatmentsData>) =>
  queryOptions<
    ...
    GetTreatmentsError,
    GetTreatmentsResponse,
    ReturnType<typeof getTreatmentsQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 * Crear tratamiento
 */
export const createTreatmentMutation = (
  options?: Partial<Options<CreateTreatmentData>>
): UseMutationOptions<
  CreateTreatmentResponse,
  CreateTreatmentError,
  Options<CreateTreatmentData>
> => {
  const mutationOptions: UseMutationOptions<
    CreateTreatmentResponse,
    CreateTreatmentError,
 ...
 */
export const deleteTreatmentMutation = (
  options?: Partial<Options<DeleteTreatmentData>>
): UseMutationOptions<
  DeleteTreatmentResponse,
  DeleteTreatmentError,
  Options<DeleteTreatmentData>
> => {
  const mutationOptions: UseMutationOptions<
    DeleteTreatmentResponse,
    DeleteTreatmentError,
...
export const getTreatmentByIdQueryKey = (
  options: Options<GetTreatmentByIdData>
) => createQueryKey("getTreatmentById", options);

/**
 * Obtener datos de un tratamiento específico
 */
export const getTreatmentByIdOptions = (
  options: Options<GetTreatmentByIdData>
) =>
  queryOptions<
    GetTreatmentByIdResponse,
    GetTreatmentByIdError,
    GetTreatmentByIdResponse,
    ReturnType<typeof getTreatmentByIdQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const updateTreatmentMutation = (
  options?: Partial<Options<UpdateTreatmentData>>
): UseMutationOptions<
  UpdateTreatmentResponse,
  UpdateTreatmentError,
  Options<UpdateTreatmentData>
> => {
  const mutationOptions: UseMutationOptions<
    UpdateTreatmentResponse,
    UpdateTreatmentError,
...
export const getIntakesByTreatmentQueryKey = (
  options: Options<GetIntakesByTreatmentData>
) => createQueryKey("getIntakesByTreatment", options);

/**
 * Obtener todas las tomas de un tratamiento
 */
export const getIntakesByTreatmentOptions = (
  options: Options<GetIntakesByTreatmentData>
) =>
  queryOptions<
    GetIntakesByTreatmentResponse,
    GetIntakesByTreatmentError,
    GetIntakesByTreatmentResponse,
    ReturnType<typeof getIntakesByTreatmentQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const createIntakeMutation = (
  options?: Partial<Options<CreateIntakeData>>
): UseMutationOptions<
  CreateIntakeResponse,
  CreateIntakeError,
  Options<CreateIntakeData>
> => {
  const mutationOptions: UseMutationOptions<
    CreateIntakeResponse,
    CreateIntakeError,
 ...
 */
export const deleteIntakeMutation = (
  options?: Partial<Options<DeleteIntakeData>>
): UseMutationOptions<
  DeleteIntakeResponse,
  DeleteIntakeError,
  Options<DeleteIntakeData>
> => {
  const mutationOptions: UseMutationOptions<
    DeleteIntakeResponse,
    DeleteIntakeError,
...
export const getAllMedicinesQueryKey = (
  options?: Options<GetAllMedicinesData>
) => createQueryKey("getAllMedicines", options);

/**
 * Obtener todas las medicinas disponibles en el sistema
 */
export const getAllMedicinesOptions = (
  options?: Options<GetAllMedicinesData>
) =>
  queryOptions<
    GetAllMedicinesResponse,
    GetAllMedicinesError,
    GetAllMedicinesResponse,
    ReturnType<typeof getAllMedicinesQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
